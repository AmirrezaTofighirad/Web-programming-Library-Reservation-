...
$user = $result->fetch_assoc(); // Fetch a row as an associative array from result
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_profile'])) {
    ...
    $sql_update = "UPDATE users SET firstname = ?, lastname = ?, phone = ?, address = ?, email = ? WHERE id = ?";
    $stmt_update = $conn->prepare($sql_update);
    $stmt_update->bind_param('sssssi', $firstname, $lastname, $phone, $address, $email, $user_id);
